...
class BasketPage(BasePage):
    def should_be_clickable_header_basket_button(self):
         ...
         # Ждем явным ожиданием 
            button = WebDriverWait(self.browser, 5).until(EC.element_to_be_clickable((By.XPATH,BasketPageLocators.HEADER_BASKET_BUTTON[1])))
    ...
    #def should_not_be_products_inside_basket(self):
